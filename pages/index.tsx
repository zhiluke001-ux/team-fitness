            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="card">
                ...
                <div className="text-xs text-gray-600 mt-1 space-y-1">
                  <div>Every 1 km logged: {POINTS.perKm} pts</div>
                  <div>Every 1,000 calories burned: {POINTS.per1000Calories} pts</div>
                  <div>Each workout: {POINTS.perWorkout} pts</div>
                  <div>Each healthy meal: {POINTS.perHealthyMeal} pts</div>
                  <div>All members ≥2 workouts/week (auto): +{POINTS.bonusAllMinWorkouts}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="card">
              ...
              <div className="flex flex-wrap gap-2">
                <Badge ok={everyHas2Workouts} text={`All ≥2 workouts (+${POINTS.bonusAllMinWorkouts})`} />
                <Badge ok={manualSum > 0} text={`Admin bonuses (+${manualSum})`} />
              </div>
              {/* Detailed list of admin bonuses */}
              {bonusList.length > 0 && (
